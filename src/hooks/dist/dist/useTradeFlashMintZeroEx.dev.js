...
exports.useTradeFlashMintZeroEx = function () {
  ...
  var executeFlashMintZeroExTrade = react_1.useCallback(function (quote, slippage, override) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!address || !chainId || !quote) return [2
            /*return*/
            ];
            ...
            if (!outputTokenAddress || !inputTokenAddress) return [2
            /*return*/
            ];
            ...
            if (spendingTokenBalance.lt(requiredBalance)) return [2
            /*return*/
            ];
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , flashMintZeroExTransaction_1.getFlashMintZeroExTransaction(isMinting, inputToken, outputToken, indexTokenAmount, inputOutputTokenAmount, componentQuotes, provider, signer, chainId)];
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , gasEstimatooor.estimate(tx, canFail)];

          case 3:
            gasLimit_1 = _a.sent();
            if (!isMinting) return [3
            /*break*/
            , 8];
            isSellingNativeChainToken = inputToken.symbol === tokens_1.ETH.symbol || inputToken.symbol === tokens_1.MATIC.symbol;
            if (!isSellingNativeChainToken) return [3
            /*break*/
            , 5];
            ...
            return [4
            /*yield*/
            , flashMint.mintExactSetFromETH(outputTokenAddress, indexTokenAmount, componentQuotes, issuanceModule.address, issuanceModule.isDebtIssuance, inputOutputTokenAmount, {
              gasLimit: gasLimit_1
            })];
          ...
          case 5:
            ...
            return [4
            /*yield*/
            , flashMint.mintExactSetFromToken(outputTokenAddress, inputTokenAddress, indexTokenAmount, maxAmountInputToken, componentQuotes, issuanceModule.address, issuanceModule.isDebtIssuance, {
              gasLimit: gasLimit_1
            })];
          ...
          case 8:
            isRedeemingNativeChainToken = outputToken.symbol === tokens_1.ETH.symbol || outputToken.symbol === tokens_1.MATIC.symbol;
            ...
            if (!isRedeemingNativeChainToken) return [3
            /*break*/
            , 10];
            return [4
            /*yield*/
            , flashMint.redeemExactSetForETH(inputTokenAddress, indexTokenAmount, minOutputReceive, componentQuotes, issuanceModule.address, issuanceModule.isDebtIssuance, {
              gasLimit: gasLimit_1
            })];
          ...
          case 10:
            ...
            return [4
            /*yield*/
            , flashMint.redeemExactSetForToken(inputTokenAddress, outputTokenAddress, indexTokenAmount, minOutputReceive, componentQuotes, issuanceModule.address, issuanceModule.isDebtIssuance, {
              gasLimit: gasLimit_1
            })];
          ...
          case 13:
            ...
            if (error_1 instanceof gasEstimatooor_1.GasEstimatooorFailedError && error_1.statusCode === 1001) {
              setTxWouldFail(true);
            }
  ...
  return {
    executeFlashMintZeroExTrade: executeFlashMintZeroExTrade,
    isTransacting: isTransacting,
    txWouldFail: txWouldFail
  };
};