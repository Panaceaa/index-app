...
__export(src_exports, {
  B4BIndex: () => B4BIndex,
  BTC2xFlexibleLeverageIndex: () => BTC2xFlexibleLeverageIndex,
  BTC2xFlexibleLeverageIndexPolygon: () => BTC2xFlexibleLeverageIndexPolygon,
  BanklessBEDIndex: () => BanklessBEDIndex,
  BasicIssuanceModuleAddress: () => BasicIssuanceModuleAddress,
  BasicIssuanceModulePolygonAddress: () => BasicIssuanceModulePolygonAddress,
  DAI: () => DAI,
  DebtIssuanceModuleAddress: () => DebtIssuanceModuleAddress,
  DebtIssuanceModuleV2Address: () => DebtIssuanceModuleV2Address,
  DebtIssuanceModuleV2PolygonAddress: () => DebtIssuanceModuleV2PolygonAddress,
  DefiPulseIndex: () => DefiPulseIndex,
  DiversifiedStakedETHIndex: () => DiversifiedStakedETHIndex,
  ERC4626QuoteProvider: () => ERC4626QuoteProvider,
  ERC4626TransactionBuilder: () => ERC4626TransactionBuilder,
  ETH: () => ETH,
  ETH2xFlexibleLeverageIndex: () => ETH2xFlexibleLeverageIndex,
  ETH2xFlexibleLeverageIndexPolygon: () => ETH2xFlexibleLeverageIndexPolygon,
  Exchange: () => Exchange,
  ExchangeIssuanceLeveragedMainnetAddress: () => ExchangeIssuanceLeveragedMainnetAddress,
  ExchangeIssuanceLeveragedPolygonAddress: () => ExchangeIssuanceLeveragedPolygonAddress,
  ExchangeIssuanceZeroExMainnetAddress: () => ExchangeIssuanceZeroExMainnetAddress,
  ExchangeIssuanceZeroExPolygonAddress: () => ExchangeIssuanceZeroExPolygonAddress,
  FlashMint4626Address: () => FlashMint4626Address,
  FlashMintContractType: () => FlashMintContractType,
  FlashMintLeveraged: () => FlashMintLeveraged,
  FlashMintLeveragedForCompoundAddress: () => FlashMintLeveragedForCompoundAddress,
  FlashMintQuoteProvider: () => FlashMintQuoteProvider,
  FlashMintWrappedAddress: () => FlashMintWrappedAddress,
  FlashMintZeroEx: () => FlashMintZeroEx,
  FlashMintZeroExMainnetAddress: () => FlashMintZeroExMainnetAddress,
  GMIIndex: () => GMIIndex,
  GitcoinStakedETHIndex: () => GitcoinStakedETHIndex,
  IndexDebtIssuanceModuleV2Address: () => IndexDebtIssuanceModuleV2Address,
  InterestCompoundingETHIndex: () => InterestCompoundingETHIndex,
  InverseBTCFlexibleLeverageIndex: () => InverseBTCFlexibleLeverageIndex,
  InverseETHFlexibleLeverageIndex: () => InverseETHFlexibleLeverageIndex,
  InverseMATICFlexibleLeverageIndex: () => InverseMATICFlexibleLeverageIndex,
  JPGIndex: () => JPGIndex,
  LeveragedTransactionBuilder: () => LeveragedTransactionBuilder,
  MATIC: () => MATIC,
  MATIC2xFlexibleLeverageIndex: () => MATIC2xFlexibleLeverageIndex,
  MetaverseIndex: () => MetaverseIndex,
  MoneyMarketIndexToken: () => MoneyMarketIndexToken,
  USDC: () => USDC,
  USDT: () => USDT,
  WETH: () => WETH,
  Web3DataEconomyIndex: () => Web3DataEconomyIndex,
  WrappedQuoteProvider: () => WrappedQuoteProvider,
  WrappedTransactionBuilder: () => WrappedTransactionBuilder,
  ZeroExApi: () => ZeroExApi,
  ZeroExTransactionBuilder: () => ZeroExTransactionBuilder,
  collateralDebtSwapData: () => collateralDebtSwapData,
  debtCollateralSwapData: () => debtCollateralSwapData,
  extractPoolFees: () => extractPoolFees,
  getAddressForToken: () => getAddressForToken,
  getEchangeFrom0xKey: () => getEchangeFrom0xKey,
  getExchangeIssuanceLeveragedContractAddress: () => getExchangeIssuanceLeveragedContractAddress,
  getExchangeIssuanceZeroExContractAddress: () => getExchangeIssuanceZeroExContractAddress,
  getFlashMint4626Contract: () => getFlashMint4626Contract,
  getFlashMintLeveragedContract: () => getFlashMintLeveragedContract,
  getFlashMintLeveragedContractForToken: () => getFlashMintLeveragedContractForToken,
  getFlashMintLeveragedForCompoundContract: () => getFlashMintLeveragedForCompoundContract,
  getFlashMintLeveragedQuote: () => getFlashMintLeveragedQuote,
  getFlashMintWrappedContract: () => getFlashMintWrappedContract,
  getFlashMintZeroExContract: () => getFlashMintZeroExContract,
  getFlashMintZeroExContractForToken: () => getFlashMintZeroExContractForToken,
  getFlashMintZeroExQuote: () => getFlashMintZeroExQuote,
  getIncludedSources: () => getIncludedSources,
  getIndexFlashMintZeroExContract: () => getIndexFlashMintZeroExContract,
  getIndexFlashMintZeroExContractAddress: () => getIndexFlashMintZeroExContractAddress,
  getIssuanceComponentSwapData: () => getIssuanceComponentSwapData,
  getIssuanceERC4626SwapData: () => getIssuanceERC4626SwapData,
  getIssuanceModule: () => getIssuanceModule,
  getPaymentTokenAddress: () => getPaymentTokenAddress,
  getRedemptionComponentSwapData: () => getRedemptionComponentSwapData,
  getRedemptionERC4626SwapData: () => getRedemptionERC4626SwapData,
  getRequiredComponents: () => getRequiredComponents,
  getSwapData: () => getSwapData,
  getSwapDataAndPaymentTokenAmount: () => getSwapDataAndPaymentTokenAmount,
  getSwapDataCollateralDebt: () => getSwapDataCollateralDebt,
  getSwapDataDebtCollateral: () => getSwapDataDebtCollateral,
  getWrapData: () => getWrapData,
  inputSwapData: () => inputSwapData,
  outputSwapData: () => outputSwapData,
  sETH2: () => sETH2,
  slippageAdjustedTokenAmount: () => slippageAdjustedTokenAmount,
  stETH: () => stETH,
  swapDataFrom0xQuote: () => swapDataFrom0xQuote,
  wei: () => wei,
  wsETH2: () => wsETH2,
  wstETH: () => wstETH
});
...
var ExchangeIssuanceZeroExPolygonAddress = "0x0F5C21d4929f6F17119f43b0c51E665f12367A19";
...
var getSwapDataCollateralDebt = async (leveragedTokenData, includedSources, slippage, chainId, zeroExApi) => {
  ...
  const collateralSold = import_bignumber.BigNumber.from(zeroExQuote.sellAmount);
...
var getSwapDataDebtCollateral = async (leveragedTokenData, includedSources, slippage, chainId, zeroExApi) => {
  ...
  if (!result)
    return null;
  const { swapData: swapDataDebtCollateral, zeroExQuote } = result;
  const collateralObtained = import_bignumber.BigNumber.from(zeroExQuote.buyAmount);
  return {
...
var BanklessBEDIndex = {
  address: "0x2aF1dF3AB0ab157e1E2Ad8F88A7D04fbea0c7dc6",
  symbol: "BED"
};
var BTC2xFlexibleLeverageIndex = {
...
var DiversifiedStakedETHIndex = {
  address: "0x341c05c0E9b33C0E38d64de76516b2Ce970bB3BE",
  symbol: "dsETH"
};
var ETH2xFlexibleLeverageIndex = {
  address: "0xAa6E8127831c9DE45ae56bB1b0d4D4Da6e5665BD",
  symbol: "ETH2x-FLI"
};
var GitcoinStakedETHIndex = {
  address: "0x36c833Eed0D376f75D1ff9dFDeE260191336065e",
  symbol: "gtcETH"
};
var InterestCompoundingETHIndex = {
  symbol: "icETH",
...
var BTC2xFlexibleLeverageIndexPolygon = {
  symbol: "BTC2x-FLI-P"
};
var ETH2xFlexibleLeverageIndexPolygon = {
  symbol: "ETH2X-FLI-P"
};
var GMIIndex = {
  symbol: "GMI",
...
var InverseBTCFlexibleLeverageIndex = {
  symbol: "iBTC-FLI-P"
};
var InverseETHFlexibleLeverageIndex = {
  symbol: "iETH-FLI-P"
};
var InverseMATICFlexibleLeverageIndex = {
  symbol: "iMATIC-FLI-P"
};
var MATIC2xFlexibleLeverageIndex = {
  symbol: "MATIC2x-FLI-P"
};
var Web3DataEconomyIndex = {
  symbol: "DATA"
};
...
var import_bignumber3 = require("@ethersproject/bignumber");
...
var getAmountOfAssetToObtainShares = async (component, shares, provider, slippage = DEFAULT_SLIPPAGE) => {
  const componentContract = new import_contracts7.Contract(component, erc4626Abi, provider);
  const defaultSlippageBN = import_bignumber2.BigNumber.from(Math.round(slippage * 1e4));
  const slippageBigNumber = isFCASH(component) ? defaultSlippageBN.mul(3) : defaultSlippageBN;
  const multiplier = import_bignumber2.BigNumber.from(1e4).add(slippageBigNumber);
...
async function getIssuanceComponentSwapData(indexTokenSymbol, indexToken, inputToken, indexTokenAmount, provider) {
  ...
  const issuance = new import_contracts7.Contract(issuanceModule.address, IssuanceAbi, provider);
...
async function getUnderlyingErc20(token, provider) {
  ...
  const contract = new import_contracts7.Contract(token, IERC4262_ABI, provider);
...
var WrappedQuoteProvider = class {
  ...
  async getQuote(request) {
    ...
    if (componentSwapData.length !== componentSwapData.length)
      return null;
    let estimatedInputOutputAmount = import_bignumber3.BigNumber.from(0);
...
const { selectSlippage } = require("utils/slippage");
var ComponentsQuoteProvider = class {
  ...
  async getComponentQuotes(components, positions, isMinting, inputToken, outputToken) {
    ...
    const inputOutputTokenAmount = results.map(
      (result) => import_bignumber5.BigNumber.from(isMinting ? result.sellAmount : result.buyAmount)
